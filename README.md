...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-salad-9dd2
```

A live public deployment of this template is available at [https://square-salad-9dd2.templates.workers.dev](https://square-salad-9dd2.templates.workers.dev)
